...
export interface AxiosTransform {
    transformRequestHook: <T>(res: AxiosResponse<Result>, options: RequestOptions) => Promise<Result<T>>;
...
export const transform: AxiosTransform = {
     ...
     */
    transformRequestHook: async <T>(res: AxiosResponse<Result<T>>, options: RequestOptions) => {
        ...
        const errorMessage = error || '服务器响应失败';
