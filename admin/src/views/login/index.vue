  ...
  <div class="container">
    <div class="main">
      ...
      <div class="login">
        ...
        <div class="org-info">
          <img v-if="orgInfo" class="org-logo" :src="orgInfo?.logoUrl" />
          <img v-else class="org-logo" src="../../assets/org_logo.png" />
        ...
        <el-link href="https://www.truckego.com/#/" target="_blank"
          >深圳卡车易购互联网科技有限公司</el-link
        >
        <el-link
          href="https://beian.miit.gov.cn/#/Integrated/index"
          target="_blank"
          class="footer"
          >粤ICP备19015928号-4</el-link
        >
      </div>
    </div>
  </div>
...
const orgInfo = orgInfoLocalData.get();
