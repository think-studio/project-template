...
function loadAMap() {
    ...
    window._AMapSecurityConfig = {
        securityJsCode: "19cc43429edd933209224b31e23287c0",
    };
    onMounted(() => {
        AMapLoader.load({
            ...
            version: "2.0",
            AMapUI: {},
            plugins: ["AMap.Geocoder", "AMap.AutoComplete", "AMap.GraspRoad", "AMap.MouseTool", "AMap.CircleEditor", "AMap.MoveAnimation"],
        }).then(() => {
